...
import { generatePack } from '../logic/packGenerator.js?v=8';
import { decrementPlayerPack } from '../data/packsRepo.js?v=8';
import { addCardsBatch } from '../data/cardsRepo.js?v=8';
import { getUser } from '../logic/supaRaw.js?v=8';
