...
import { tickSkillCooldowns, setActiveChampion, useSkill, canUseSkill } from './skillEngine.js?v=17';
...
export { canUseSkill, getSkillCooldownLeft } from './skillEngine.js?v=17';
