...
import { tickSkillCooldowns, setActiveChampion, useSkill, canUseSkill } from './skillEngine.js?v=8';
...
export { canUseSkill, getSkillCooldownLeft } from './skillEngine.js?v=8';
