...
import { generatePack } from '../logic/packGenerator.js?v=15';
import { decrementPlayerPack } from '../data/packsRepo.js?v=15';
import { addCardsBatch } from '../data/cardsRepo.js?v=15';
import { getUser } from '../logic/supaRaw.js?v=15';
