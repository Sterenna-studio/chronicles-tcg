// app/views/battle.js
import { createBattle, playCard, getBattleResult, startTurn, mulligan, START_HP } from '../../logic/battleEngine.js?v=22';
import { runEnemyTurn } from '../../logic/aiEngine.js?v=22';
...
import { getDailyChallenges, checkAndCompleteChallenges, getChallengeProgress } from '../../logic/challengeEngine.js?v=22';
...
export async function renderBattle(root, opts = {}) {
  ...
  if (playerDeck.length < 1) {
    ...
    root.querySelector('#go-deck').addEventListener('click', () => {
      import('./deckBuilder.js?v=22').then(m => m.renderDeckBuilder(root));
    });
    return;
  }
...
function renderDailyChallenges() {
  ...
  if (!el) return;
  import('../../logic/challengeEngine.js?v=22').then(({ getDailyChallenges, getChallengeProgress }) => {
