...
import { tickSkillCooldowns, setActiveChampion, useSkill, canUseSkill } from './skillEngine.js?v=18';
...
export { canUseSkill, getSkillCooldownLeft } from './skillEngine.js?v=18';
