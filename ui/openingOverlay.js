...
import { generatePack } from '../logic/packGenerator.js?v=10';
import { decrementPlayerPack } from '../data/packsRepo.js?v=10';
import { addCardsBatch } from '../data/cardsRepo.js?v=10';
import { getUser } from '../logic/supaRaw.js?v=10';
