...
import { generatePack } from '../logic/packGenerator.js?v=9';
import { decrementPlayerPack } from '../data/packsRepo.js?v=9';
import { addCardsBatch } from '../data/cardsRepo.js?v=9';
import { getUser } from '../logic/supaRaw.js?v=9';
