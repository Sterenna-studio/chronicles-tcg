...
import { tickSkillCooldowns, setActiveChampion, useSkill, canUseSkill } from './skillEngine.js?v=6';
...
export { canUseSkill, getSkillCooldownLeft } from './skillEngine.js?v=6';
