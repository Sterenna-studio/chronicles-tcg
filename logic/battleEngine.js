...
import { tickSkillCooldowns, setActiveChampion, useSkill, canUseSkill } from './skillEngine.js?v=24';
...
export { canUseSkill, getSkillCooldownLeft } from './skillEngine.js?v=24';
