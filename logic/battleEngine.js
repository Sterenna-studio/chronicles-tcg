...
import { tickSkillCooldowns, setActiveChampion, useSkill, canUseSkill } from './skillEngine.js?v=14';
...
export { canUseSkill, getSkillCooldownLeft } from './skillEngine.js?v=14';
