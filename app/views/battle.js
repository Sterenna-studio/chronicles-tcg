// app/views/battle.js
import { createBattle, playCard, getBattleResult, startTurn, mulligan, START_HP } from '../../logic/battleEngine.js?v=13';
import { runEnemyTurn } from '../../logic/aiEngine.js?v=13';
import { getClient, getUser } from '../../logic/supaRaw.js?v=13';
import { url } from '../../logic/paths.js?v=13';
import { playableSets } from '../../logic/sets.js?v=13';
import { getDailyChallenges, checkAndCompleteChallenges, getChallengeProgress } from '../../logic/challengeEngine.js?v=13';
...
export async function renderBattle(root, opts = {}) {
  ...
  if (playerDeck.length < 1) {
    ...
    root.querySelector('#go-deck').addEventListener('click', () => {
      import('./deckBuilder.js?v=13').then(m => m.renderDeckBuilder(root));
    });
    return;
  }
...
function renderDailyChallenges() {
  ...
  if (!el) return;
  import('../../logic/challengeEngine.js?v=13').then(({ getDailyChallenges, getChallengeProgress }) => {
