...
import { tickSkillCooldowns, setActiveChampion, useSkill, canUseSkill } from './skillEngine.js?v=10';
...
export { canUseSkill, getSkillCooldownLeft } from './skillEngine.js?v=10';
