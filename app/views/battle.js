// app/views/battle.js
import { createBattle, playCard, getBattleResult, startTurn, mulligan, START_HP } from '../../logic/battleEngine.js?v=17';
import { runEnemyTurn } from '../../logic/aiEngine.js?v=17';
...
import { getDailyChallenges, checkAndCompleteChallenges, getChallengeProgress } from '../../logic/challengeEngine.js?v=17';
...
export async function renderBattle(root, opts = {}) {
  ...
  if (playerDeck.length < 1) {
    ...
    root.querySelector('#go-deck').addEventListener('click', () => {
      import('./deckBuilder.js?v=17').then(m => m.renderDeckBuilder(root));
    });
    return;
  }
...
function renderDailyChallenges() {
  ...
  if (!el) return;
  import('../../logic/challengeEngine.js?v=17').then(({ getDailyChallenges, getChallengeProgress }) => {
