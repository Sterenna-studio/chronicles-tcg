...
import { generatePack } from '../logic/packGenerator.js?v=4';
import { decrementPlayerPack } from '../data/packsRepo.js?v=4';
import { addCardsBatch } from '../data/cardsRepo.js?v=4';
import { getUser } from '../logic/supaRaw.js?v=4';
