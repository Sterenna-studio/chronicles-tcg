...
import { tickSkillCooldowns, setActiveChampion, useSkill, canUseSkill } from './skillEngine.js?v=15';
...
export { canUseSkill, getSkillCooldownLeft } from './skillEngine.js?v=15';
