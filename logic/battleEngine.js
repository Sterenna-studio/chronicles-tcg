...
import { tickSkillCooldowns, setActiveChampion, useSkill, canUseSkill } from './skillEngine.js?v=12';
...
export { canUseSkill, getSkillCooldownLeft } from './skillEngine.js?v=12';
